...
public class FragmentDrawer extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        count = getActivity().getResources().getStringArray(R.array.Count);

        icon = new int[]{R.mipmap.menu, R.mipmap.offers, R.mipmap.mycart, R.mipmap.lastorder, R.mipmap.favorite, R.mipmap.setting,
                R.mipmap.support};
    }
